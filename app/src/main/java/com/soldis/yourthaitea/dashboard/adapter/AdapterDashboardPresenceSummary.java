 ...
 */
public class AdapterDashboardPresenceSummary extends  RecyclerView.Adapter<AdapterDashboardPresenceSummary.ViewHolder>{
    Tbl_Presence tblPresence;
    private Context context;
    RecyclerView.Adapter mAdapter;

    public AdapterDashboardPresenceSummary(Context context, Tbl_Presence tblPresence, OnDownloadClicked listener) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        //holder.txtType.setText(dat.SALES_TYPE);
        ...
        //if (dat.TOTAL_SALES > 0 )holder.imgStatus.setImageDrawable(context.getResources().getDrawable(R.drawable.ball_green));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
        ...
        public ViewHolder(View itemView,
                          ...
                          final AdapterDashboardPresenceSummary mCourseAdapter) {
            super(itemView);
