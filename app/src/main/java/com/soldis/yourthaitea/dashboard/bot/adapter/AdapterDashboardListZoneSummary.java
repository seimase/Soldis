 ...
 */
public class AdapterDashboardListZoneSummary extends  RecyclerView.Adapter<AdapterDashboardListZoneSummary.ViewHolder>{
    Tbl_ListZone listZone;
    private Context context;

    public AdapterDashboardListZoneSummary(Context context, Tbl_ListZone listZone, OnDownloadClicked listener) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.layout_row.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent mIntent = new Intent(context, Dashboard_ASM_SummaryActivity.class);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
        ...
        public ViewHolder(View itemView,
                          ...
                          final AdapterDashboardListZoneSummary mCourseAdapter) {
            super(itemView);
