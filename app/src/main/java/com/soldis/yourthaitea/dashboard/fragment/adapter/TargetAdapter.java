package com.soldis.yourthaitea.dashboard.fragment.adapter;
...
public class TargetAdapter extends PagerAdapter {
    ...
    public void setData(final ArrayList<Tbl_TargetTmp> data) {
        ...
        for (Tbl_TargetTmp dat : data){
            ...
            View convertView = LayoutInflater.from(context).inflate(R.layout.row_summary_sales, null);
            ...
            holder.txtTargetMonth = (TextView)convertView.findViewById(R.id.txtTargetMonth);
            holder.txtAchMonth = (TextView)convertView.findViewById(R.id.txtAchMonth);
            ...
            holder.txtAchMonth.setText(AppController.getInstance().toCurrency(dat.ACH_MONTH));
            holder.txtTargetDay.setText(AppController.getInstance().toCurrency(dat.TARGET_DAY));
            holder.txtTargetMonth.setText(AppController.getInstance().toCurrency(dat.TARGET_MONTH));
            ...
            if (dat.TARGET_TYPE.equals("EC Target")){
                ...
                holder.txtAchMonth.setText(AppController.getInstance().toCurrencyRp(dat.ACH_MONTH));
                holder.txtTargetDay.setText(AppController.getInstance().toCurrencyRp(dat.TARGET_DAY));
                holder.txtTargetMonth.setText(AppController.getInstance().toCurrencyRp(dat.TARGET_MONTH));
