 ...
 */
public class AdapterDashboardListZonePresenceSummary extends  RecyclerView.Adapter<AdapterDashboardListZonePresenceSummary.ViewHolder>{
    Tbl_ListZone listZone;
    private Context context;

    public AdapterDashboardListZonePresenceSummary(Context context, Tbl_ListZone listZone, OnDownloadClicked listener) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.layout_row.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent mIntent = new Intent(context, Dashboard_ASM_SummaryPresenceActivity.class);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
        ...
        public ViewHolder(View itemView,
                          ...
                          final AdapterDashboardListZonePresenceSummary mCourseAdapter) {
            super(itemView);
