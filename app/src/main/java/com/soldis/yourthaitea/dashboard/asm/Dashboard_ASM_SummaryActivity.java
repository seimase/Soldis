...
import com.soldis.yourthaitea.dashboard.asm.adapter.AdapterDashboardListDepoSummary;
...
public class Dashboard_ASM_SummaryActivity extends AppCompatActivity {
    ...
    void FillGrid(){
        lySync.setVisibility(View.GONE);
        mAdapter = new AdapterDashboardListDepoSummary(this, listDepo, new AdapterDashboardListDepoSummary.OnDownloadClicked() {
            @Override
