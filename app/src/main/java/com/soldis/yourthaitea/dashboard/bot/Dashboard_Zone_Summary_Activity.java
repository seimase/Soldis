...
public class Dashboard_Zone_Summary_Activity extends AppCompatActivity  {
    ...
    void InitControl(){
        ...
        txtLabel.setText(getResources().getString(R.string.main_dashboard));
    ...
    void FillGrid(){
        mAdapter = new AdapterDashboardListZoneSummary(this, listZone, new AdapterDashboardListZoneSummary.OnDownloadClicked() {
            @Override
