...
import com.soldis.yourthaitea.dashboard.bot.adapter.AdapterDashboardListZoneSummary;
import com.soldis.yourthaitea.dashboard.data_outlet.adapter.AdapterDashboardListZoneOutlet;
...
public class Dashboard_Zone_Outlet_Activity extends AppCompatActivity  {
    ...
    void FillGrid(){
        mAdapter = new AdapterDashboardListZoneOutlet(this, listZone, new AdapterDashboardListZoneOutlet.OnDownloadClicked() {
            @Override
