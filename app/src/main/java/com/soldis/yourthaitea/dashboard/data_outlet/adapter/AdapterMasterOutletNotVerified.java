 ...
 */
public class AdapterMasterOutletNotVerified extends  RecyclerView.Adapter<AdapterMasterOutletNotVerified.ViewHolder>{
    Tbl_Dashboard_DataOutlet dashboardDataOutlet;
    private Context context;

    public AdapterMasterOutletNotVerified(Context context, Tbl_Dashboard_DataOutlet dashboardDataOutlet, OnDownloadClicked listener) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        final Tbl_Dashboard_DataOutlet.OutletNotVerified dat = dashboardDataOutlet.outlet_not_verified.get(position);
    ...
    public int getItemCount() {
        return dashboardDataOutlet.outlet_not_verified.size();
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
        ...
        public ViewHolder(View itemView,
                          ...
                          final AdapterMasterOutletNotVerified mCourseAdapter) {
            super(itemView);
