...
public class ListTypeout extends AppCompatActivity {
    TextView txtLabel;
    ...
    void FillGrid(){
        ...
        mAdapter = new AdapterListTypeOut(this, objTypeouts, new AdapterListTypeOut.OnDownloadClicked() {
            @Override
            public void OnDownloadClicked(String TYPEOUT, String TYPENAME) {
                Intent mIntent = new Intent();
                mIntent.putExtra("TYPEOUT", TYPEOUT);
