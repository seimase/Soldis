 ...
 */
public class AdapterOrderConfimation extends  RecyclerView.Adapter<AdapterOrderConfimation.ViewHolder>  {
    ArrayList <Obj_MASTER> ObjMaster;
    private Context context;
    boolean bTRX;

    public AdapterOrderConfimation(Context context, ArrayList <Obj_MASTER> ObjMaster,
                                   boolean bTRX,
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)  {
        ...
        View itemView = LayoutInflater.from(parent.getContext()).inflate(
                R.layout.row_order_confirmation, null);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
        ...
        public ViewHolder(View itemView,
                          ...
                          final AdapterOrderConfimation mCourseAdapter) {
            super(itemView);
