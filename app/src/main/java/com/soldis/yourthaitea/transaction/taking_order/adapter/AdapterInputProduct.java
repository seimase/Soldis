 ...
 */
public class AdapterInputProduct extends  RecyclerView.Adapter<AdapterInputProduct.ViewHolder>  {
    ArrayList <Obj_MASTER> ObjMaster;
    private Context context;
    boolean bTRX;

    public AdapterInputProduct(Context context, ArrayList <Obj_MASTER> ObjMaster,
                               boolean bTRX,
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
        ...
        public ViewHolder(View itemView,
                          ...
                          final AdapterInputProduct mCourseAdapter,
    ...
    private class MyCustomEditTextListener implements TextWatcher {
        ...
        public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
            ...
            holder.txtQty.setText(charSequence.toString());
            listener.OnDownloadClicked();
        }
