 ...
 */
public class AdapterViewOrder extends  RecyclerView.Adapter<AdapterViewOrder.ViewHolder>  {
    ArrayList <Obj_MASTER> ObjMaster;
    private Context context;
    boolean bTRX;

    public AdapterViewOrder(Context context, ArrayList <Obj_MASTER> ObjMaster,
                            boolean bTRX,
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
        ...
        public ViewHolder(View itemView,
                          ...
                          final AdapterViewOrder mCourseAdapter) {
            super(itemView);
