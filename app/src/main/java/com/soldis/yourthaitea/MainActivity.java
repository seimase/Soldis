...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tblKaryawan = AppController.getInstance().getSessionManager().getUserProfile();
        AppConstant.strSlsNo = "";
        AppConstant.strSlsName  = "";
        AppConstant.strMitraID = "";

        if (tblKaryawan != null && tblKaryawan.data.size() > 0){
            for (Tbl_Karyawan.Datum dat : tblKaryawan.data){
                ...
                AppConstant.dblUangMakan = dat.UANG_MAKAN;
                AppConstant.strPrefixID = dat.PREFIX_ID;

                EMAIL_ID = "";
                PHONE_NUMBER = "";

                if (dat.PHOTO != null && !dat.PHOTO.equals("")){
                    AppController.getInstance().displayImage(MainActivity.this , AppConstant.PHOTO_MOTORIS_URL + dat.PHOTO, imgAvatar);
                }else{
    ...
    void InitControl(){
        ...
        lyOutlet.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //mIntent = new Intent(getBaseContext(), ListStockActivity.class);
            ...
            public void onClick(View view) {
                if (VisitValidationStart()){
                    ...
                    if (objMotoris.getSLSNO() != null){
                        iSeqNo = (int) objMotoris.getSEQNO() + 1;
        ...
        lyRingkasan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mIntent = new Intent(getBaseContext(), ListOrderActivity.class);
                AppConstant.bClose = false;
                startActivity(mIntent);
            }
        });
            ...
            public void onClick(View view) {
                ...
                if (VisitValidation()){
                    if (AppController.getInstance().isOnline()){
                        ...
                        AppController.getInstance().CustomeDialog(MainActivity.this,getResources().getString(R.string.text_no_connection));
                    }
                }else{
        ...
        try{
            ...
            call.enqueue(new Callback<Tbl_Karyawan>() {
                ...
                public void onResponse(Call<Tbl_Karyawan> call, Response<Tbl_Karyawan> response) {
                    ...
                    progress.dismiss();
                    if (code == 200){
                        tblKaryawan = response.body();
                        if (!tblKaryawan.error){
    ...
    private void onPhotosReturned(List<File> returnedPhotos) {
        ...
        for (File file : returnedPhotos){
            ...
            try {
                ...
                AppController.getInstance().CustomeDialog(MainActivity.this,
                        "Error " + e.getMessage());
            }
        }
            ...
            call.enqueue(new Callback<Tbl_Karyawan>() {
                ...
                public void onResponse(Call<Tbl_Karyawan> call, Response<Tbl_Karyawan> response) {
                    ...
                    if (code == 200){
                        tblKaryawan = response.body();
                        if (!tblKaryawan.error){
                            if (tblKaryawan.data.size() > 0){
                                AppController.getInstance().getSessionManager().setUserAccount(null);
                                AppController.getInstance().getSessionManager().setUserAccount(tblKaryawan);
